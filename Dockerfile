...
RUN Rscript -e 'remotes::install_version("org.EcK12.eg.db",upgrade="never", version = "3.11.4")'
RUN Rscript -e 'remotes::install_version("org.Ce.eg.db",upgrade="never", version = "3.11.4")'
RUN Rscript -e 'remotes::install_version("org.Mm.eg.db",upgrade="never", version = "3.11.4")'
RUN Rscript -e 'remotes::install_version("org.Dm.eg.db",upgrade="never", version = "NA")'
RUN Rscript -e 'remotes::install_version("org.Hs.eg.db",upgrade="never", version = "3.11.4")'
...
RUN Rscript -e 'remotes::install_version("GO.db",upgrade="never", version = "3.11.4")'
...
RUN Rscript -e 'remotes::install_version("AnnotationDbi",upgrade="never", version = "1.50.3")'
RUN Rscript -e 'remotes::install_version("plotly",upgrade="never", version = "4.9.2.1")'
RUN Rscript -e 'remotes::install_version("clusterProfiler",upgrade="never", version = "3.16.1")'
RUN Rscript -e 'remotes::install_version("org.At.tair.db",upgrade="never", version = "3.11.4")'
RUN Rscript -e 'remotes::install_version("visNetwork",upgrade="never", version = "2.0.9")'
RUN Rscript -e 'remotes::install_version("GENIE3",upgrade="never", version = "1.10.0")'
RUN Rscript -e 'remotes::install_version("coseq",upgrade="never", version = "1.12.0")'
...
RUN Rscript -e 'remotes::install_version("edgeR",upgrade="never", version = "3.30.3")'
RUN Rscript -e 'remotes::install_version("limma",upgrade="never", version = "3.44.3")'
RUN Rscript -e 'remotes::install_version("shinybusy",upgrade="never", version = "0.2.2")'
RUN Rscript -e 'remotes::install_version("TCC",upgrade="never", version = "1.28.0")'
