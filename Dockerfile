...
RUN Rscript -e 'BiocManager::install("org.Ce.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'BiocManager::install("org.Mm.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'BiocManager::install("org.Dm.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'BiocManager::install("org.Hs.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'BiocManager::install("org.EcK12.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'BiocManager::install("org.At.tair.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'BiocManager::install("GO.db",upgrade="never", version = "3.12.1")'
RUN Rscript -e 'BiocManager::install("edgeR",upgrade="never", version = "3.32.1")'
RUN Rscript -e 'BiocManager::install("limma",upgrade="never", version = "3.46.0")'
RUN Rscript -e 'BiocManager::install("TCC",upgrade="never", version = "1.30.0")'
RUN Rscript -e 'BiocManager::install("clusterProfiler",upgrade="never", version = "3.18.1")'
RUN Rscript -e 'BiocManager::install("GENIE3",upgrade="never", version = "1.12.0")'
RUN Rscript -e 'BiocManager::install("coseq",upgrade="never", version = "1.14.0")'
RUN Rscript -e 'BiocManager::install("AnnotationDbi",upgrade="never", version = "1.52.0")'
