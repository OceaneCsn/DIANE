...
RUN Rscript -e 'remotes::install_version("org.Ce.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'remotes::install_version("org.Mm.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'remotes::install_version("org.Dm.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'remotes::install_version("org.Hs.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'remotes::install_version("org.EcK12.eg.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'remotes::install_version("org.At.tair.db",upgrade="never", version = "3.12.0")'
RUN Rscript -e 'remotes::install_version("GO.db",upgrade="never", version = "3.12.1")'
RUN Rscript -e 'remotes::install_version("edgeR",upgrade="never", version = "3.32.1")'
RUN Rscript -e 'remotes::install_version("limma",upgrade="never", version = "3.46.0")'
RUN Rscript -e 'remotes::install_version("TCC",upgrade="never", version = "1.30.0")'
RUN Rscript -e 'remotes::install_version("clusterProfiler",upgrade="never", version = "3.18.1")'
RUN Rscript -e 'remotes::install_version("GENIE3",upgrade="never", version = "1.12.0")'
RUN Rscript -e 'remotes::install_version("coseq",upgrade="never", version = "1.14.0")'
RUN Rscript -e 'remotes::install_version("AnnotationDbi",upgrade="never", version = "1.52.0")'
